...
\n\033[0m-----------------------------------------------------------------------
\033[1;92mAuthor \033[1;93m: Ripon Ahmed Sabbir (Dearest)
\033[1;92mWhatsapp \033[1;93m: +8801631-169330
\033[1;92mFacebook \033[1;93m: Md. Mehedi Hasan
...
def log_sel():
    ...
    if select == '1':
        ...
        os.system('xdg-open https://www.facebook.com/User.Not.Available304')
        main()
    elif select == '0':
        os.system('exit')
    elif select == '3':
        os.system('xdg-open https://youtube.com/channel/UCGS2YrRYRm8Xpo8c_0QUjyQ')
        main()
    else:
        print ''
